...
import { completed, removeTodo, favorite } from './Store/actions';
  ...
  return (
    <ListGroup className="d-flex justify-content-between align-content-center flex-row">
      ...
      <ListGroup className="d-flex p-2">
        ...
        <Button className="mb-2" variant="secondary" onClick={addfavorite}>
          Favorite
        </Button>
      </ListGroup>
    </ListGroup>
